...
import { createBufferedProxy, resolveNanimeInstance, type ProxyReturns } from '../utils/create-proxy'
import { AnimationComponentFlags, getAnimationComponentFlag } from '../utils/normalizers/instance-management'

const CHAINABLE_METHODS = new Set(['add', 'set', 'remove', 'call', 'label', 'sync'])
