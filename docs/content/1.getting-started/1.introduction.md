...
[nanime]{.text-primary} is a Nuxt module that brings [AnimeJS](https://animejs.com/){target="_blank"} into your Vue & Nuxt applications with full SSR safety and reactive composables. No manual setup, no lifecycle juggling.
